...
parser.add_argument("--inference-engine", type=str, default=None, help="Inference engine to use (torch, tensorrt, or dummy)")
...
if args.inference_engine not in ["dummy", "torch", "tensorrt"]:
